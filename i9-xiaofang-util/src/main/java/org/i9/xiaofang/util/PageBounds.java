...
public class PageBounds<T> {
    ...
    /*
     * public boolean isHasFirst() { if (currectPage == 1) { return false; } return
     * true; }
     * 
     * 
     * public boolean isHasLast() { if (currectPage == getTotalPage()) { return
     * false; } return true; }
     * 
     * public boolean isHasNext() { if (isHasLast()) { return true; } return false;
     * }
     * 
     * 
     * public boolean isHasPrevious() { if (isHasFirst()) { return true; } return
     * false; }
     */
